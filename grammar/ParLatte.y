...
ClsBody :: {
  (Maybe (Int, Int), ClsBody (Maybe (Int, Int)))
}
: '{' ListClsStmt '}' {
  (Just (tokenLineCol $1), AbsLatte.ClsBody (Just (tokenLineCol $1)) (reverse (snd $2)))
}

ClsStmt :: {
  (Maybe (Int, Int), ClsStmt (Maybe (Int, Int)))
}
: Type Ident '(' ListArg ')' Block {
  (fst $1, AbsLatte.MetDef (fst $1)(snd $1)(snd $2)(snd $4)(snd $6)) 
}
| Type ListItem ';' {
...
| Ident ListMem '=' Expr ';' {
  (fst $1, AbsLatte.AttrAss (fst $1)(snd $1)(snd $2)(snd $4)) 
}
| Ident '++' ';' {
  (fst $1, AbsLatte.Incr (fst $1)(snd $1)) 
}
| Ident ListMem '++' ';' {
  (fst $1, AbsLatte.AttrIncr (fst $1)(snd $1)(snd $2)) 
}
| Ident '--' ';' {
  (fst $1, AbsLatte.Decr (fst $1)(snd $1)) 
}
| Ident ListMem '--' ';' {
  (fst $1, AbsLatte.AttrDecr (fst $1)(snd $1)(snd $2)) 
}
| 'return' Expr ';' {
...
| '(' Expr ')' 'null' {
  (Just (tokenLineCol $1), AbsLatte.ELitNull (Just (tokenLineCol $1)) (snd $2)) 
}
| '(' Expr ')' {
...
: 'new' Type '[' Expr ']' {
  (Just (tokenLineCol $1), AbsLatte.ELitArr (Just (tokenLineCol $1)) (snd $2)(snd $4)) 
}
| 'new' Type {
  (Just (tokenLineCol $1), AbsLatte.ELitCls (Just (tokenLineCol $1)) (snd $2)) 
}
| Expr8 ListMem {
  (fst $1, AbsLatte.EExprAttr (fst $1)(snd $1)(snd $2)) 
}
| Ident ListMem {
  (fst $1, AbsLatte.ENameAttr (fst $1)(snd $1)(snd $2)) 
}
| Expr8 {
  (fst $1, snd $1)
}
...
Mem :: {
  (Maybe (Int, Int), Mem (Maybe (Int, Int)))
}
: '.' Ident {
  (Just (tokenLineCol $1), AbsLatte.MemVar (Just (tokenLineCol $1)) (snd $2)) 
}
| '[' Expr ']' {
  (Just (tokenLineCol $1), AbsLatte.MemInd (Just (tokenLineCol $1)) (snd $2)) 
}
| '.' Ident '(' ListExpr ')' {
  (Just (tokenLineCol $1), AbsLatte.MemMet (Just (tokenLineCol $1)) (snd $2)(snd $4)) 
}
